...
class SecureEnclaveManager {
    ...
    static func makeAndStorePublicKey(name: String) -> SecKey? {
    ...
    static func makeAndStoreKey(name: String) -> SecKey? {
        let access =
...
//            let e = error!.takeRetainedValue() as Error
    ...
    static func loadPublicKey(name: String) -> SecKey? {
...
extension SecureEnclaveManager {
    ...
    static func encrypt(text: String, with publicKey: SecKey) -> Data? {
    ...
    static func decrypt(data: Data, with key: SecKey, completion: @escaping (String?) -> Void) {
        let algorithm: SecKeyAlgorithm = .eciesEncryptionCofactorVariableIVX963SHA256AESGCM
...
extension  SecureEnclaveManager {
    ...
    static func verifySignature(data: Data, signature: Data, publicKey: SecKey) -> Bool {
        let algorithm: SecKeyAlgorithm = .ecdsaSignatureMessageX962SHA256
